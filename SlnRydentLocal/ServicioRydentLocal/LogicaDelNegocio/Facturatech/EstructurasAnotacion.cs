...
{
    internal class EstructurasAnotacion
    {
        ...
        public static void ITESeccionSeccion(XmlTextWriter writer, string TipoOperacion, P_Adicionales_Abonos_Dian adicionalAbono,
            decimal valorUnitarioSinIva, decimal valorIva, decimal ValorTotalMasIva, decimal PorcentajeIva, string numero = "1", int cantidad = 1, string descripcion = "")
        {
            ...
            if (lstDetalles.Any())
            {
                ...
                foreach (var detalle in lstDetalles)
                {
                    ...
                    ITESeccionSeccion(writer, TipoOperacion, adicionalAbono, valor, valorIva,
                        valor + valorIva, porcentaje, contador.ToString(), detalle.CANTIDAD ?? 1, detalle.DESCRIPCION ?? "");
